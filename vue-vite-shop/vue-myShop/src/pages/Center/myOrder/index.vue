    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="order in data.myOrder.records" :key="order.id">
                    <thead>
                        <tr>
                            <th colspan="5">
            ...
            <div class="choose-order">
                <pagination :pageNo="data.page" :total="data.myOrder.total" :pageSize="data.limit"
                    :continues="5" @nowPage='nowPage' />
            </div>
        </div>
        <!--猜你喜欢-->
        <div class="like">
